...
export class Candidatesdata extends Component<NonNullable<unknown>, spark3> {
...
export class Subscriptions extends Component<NonNullable<unknown>, spark3> {
  constructor(props: NonNullable<unknown> | Readonly<NonNullable<unknown>>) {
    super(props);
...
export const Registersbycountry = [
  ...
  {
    id: 5,
    src: '/images/flags/argentina_flag.jpg',
    city: 'Argentina',
    date: '25,Apr 2023',
    total: '92',
  },
