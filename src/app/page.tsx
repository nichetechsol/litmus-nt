...
const Firebaselogin = () => {
  ...
  const Login1 = (_e:any) => {
    ...
    if (data.email == "harsh@gmail.com" && data.password == "1234567890") {
...
router.push('/dashboard', { scroll: false })
  ...
  {err}
                  ...
                  <div className="grid grid-cols-12 gap-y-4">
                    ...
                    <button type="button" onClick={Login1} className="ti-btn ti-btn-primary !bg-primary !text-white !font-medium">Sign In</button >
                    </div>
  ...
  {err}
                  ...
                  <div className="grid grid-cols-12 gap-y-4">
                    ...
                    <div className="xl:col-span-12 col-span-12 grid mt-2">
                      <button type="button" onClick={Login} className="ti-btn ti-btn-primary !bg-primary !text-white !font-medium">Sign In</button >
                    </div>
                  </div>
                  <div className="text-center">
                    <p className="text-[0.75rem] text-[#8c9097] dark:text-white/50 mt-4">Dont have an account? <Link href="/signup" className="text-primary">Sign Up</Link></p>
