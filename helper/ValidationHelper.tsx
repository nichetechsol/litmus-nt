...
const emailSchema = Yup.string()
  ...
  .matches(/^[a-zA-Z0-9._%+-]+@[a-zA-Z0-9.-]+\.(com|in|email)$/, "Invalid email address format. Please enter a valid email address.");
...
export { SiteNameSchema, SiteAddressSchema, SiteCitySchema, PincodeSchema };